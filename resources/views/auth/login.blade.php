...
<body>
  <div class="login-container">
    ...
    <div class="login-title">Sign In to Teman Jiwa</div>
    @if($errors->any())
    ...
    <form method="POST" action="{{ route('login') }}">
      ...
      @endif
      <p class="mt-3 text-center">Don't have an account? <a href="{{ route('register') }}" class="login-link">Register here</a></p>
    </form>
  </div>
